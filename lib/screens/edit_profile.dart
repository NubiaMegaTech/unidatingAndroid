...
class EditProfilePage extends BaseRoute {
  final String? currentUserId;
  final User? thisProfileUser;

  EditProfilePage({a, o, this.currentUserId,this.thisProfileUser})
...
class _EditProfilePageState extends BaseRouteState {
